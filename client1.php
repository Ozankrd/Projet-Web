...
<div class="container my-5 py-5">
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col my-4 py-4 text-center">
                <?php echo "<a style='font-size: 20px; padding: 10px 20px; border-radius: 5px; color: white' href='listeRDV.php'>Liste RDV</a>"; ?>
                <?php echo "<a style='font-size: 20px; padding: 10px 20px; border-radius: 5px; color: white' href='boiteMail.php'>Mail</a>"; ?>
