...
<head>
    ...
    <script src="https://cdnjs.cloudflx are.com/ajax/libs/twitter-bootstrap/4.3.1/js/bootstrap.bundle.min.js"></script>
...
<nav id="nav">
    <div class="container">
        ...
        <div class="my-5 py-5">
            ...
            <?php 
                echo "<form action='clientLogin1.php' method='post'>"; ?> 
